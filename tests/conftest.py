...
_INDEX_RST_BADGE_CODECOV = '''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/fastapimobileexampleddt
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/fastapimobileexampleddt

'''
_INDEX_RST_BADGE_GITHUB_CI = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapimobileexampleddt/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/fastapimobileexampleddt/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = '''.. image:: https://img.shields.io/github/search/hendrikdutoit/fastapimobileexampleddt/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = '''.. image:: https://img.shields.io/github/license/hendrikdutoit/fastapimobileexampleddt
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = '''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/fastapimobileexampleddt
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapimobileexampleddt/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/fastapimobileexampleddt/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = '''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/fastapimobileexampleddt
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = '''.. image:: https://img.shields.io/testpypi/v/fastapimobileexampleddt
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = '''.. image:: https://img.shields.io/pypi/dm/fastapimobileexampleddt
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = '''.. image:: https://img.shields.io/pypi/status/fastapimobileexampleddt
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = '''.. image:: https://img.shields.io/pypi/wheel/fastapimobileexampleddt
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = '''.. image:: https://img.shields.io/pypi/pyversions/fastapimobileexampleddt
...
================================
fastapimobileexampleddt
================================

.. image:: https://img.shields.io/pypi/status/fastapimobileexampleddt
    :alt: PyPI - Status

.. image:: https://img.shields.io/pypi/wheel/fastapimobileexampleddt
    :alt: PyPI - Wheel

.. image:: https://img.shields.io/pypi/pyversions/fastapimobileexampleddt
    :alt: PyPI - Python Version

.. image:: https://img.shields.io/github/v/release/hendrikdutoit/fastapimobileexampleddt
    :alt: GitHub release (latest by date)

.. image:: https://img.shields.io/github/license/hendrikdutoit/fastapimobileexampleddt
    :alt: License

.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/fastapimobileexampleddt
    :alt: GitHub issues

.. image:: https://img.shields.io/pypi/dm/fastapimobileexampleddt
    :alt: PyPI - Downloads

.. image:: https://img.shields.io/github/search/hendrikdutoit/fastapimobileexampleddt/GitHub hit
    :alt: GitHub Searches

.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/fastapimobileexampleddt
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/fastapimobileexampleddt

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapimobileexampleddt/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/fastapimobileexampleddt/actions/workflows/pre-commit.yaml

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/fastapimobileexampleddt/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/fastapimobileexampleddt/actions/workflows/ci.yaml

.. image:: https://img.shields.io/testpypi/v/fastapimobileexampleddt
    :alt: PyPi
...
_PROJECT_NAME = "fastapimobileexampleddt"
  ...
  ReleaseToPyPi:
    ...
    steps:
      ...
      - name: Build distributions
        shell: bash -l fastapimobileexampleddt
